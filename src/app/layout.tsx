...
export const metadata: Metadata = {
  ...
  description: "Create stunning websites effortlessly with Webild's AI technology.",
  openGraph: {
    title: "Webild - AI-Powered Website Builder",
    description: "Create stunning websites effortlessly with Webild's AI technology.",
    url: "https://example.com",
    siteName: "Webild",
    images: [{ url: "https://images.pexels.com/photos/1089438/pexels-photo-1089438.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "Abstract green matrix code background with binary style." }],
    type: "website",
  },
  twitter: {
